...
export const DEFAULT_CODE_CLONE_MIN_TOKENS = 50;

export const DEFAULT_CODE_CLONE_MIN_LINES = 5;

export const DEFAULT_CODE_CLONE_MIN_OCCURRENCES = 2;

export const CODE_CLONE_MODULE_EXTRACTION_THRESHOLD_LINES = 50;

export const CODE_CLONE_MIRRORED_DIRECTORY_MIN_FAMILIES = 3;
